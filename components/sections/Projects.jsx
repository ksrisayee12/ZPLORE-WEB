...
const projects = [
  {
    ...
    minHeight: 'min-h-[420px] md:min-h-[560px]',
    illustration: (
...
/* ── Bento/Masonry grid layout using CSS Grid ── */
...
function ProjectCard({ project, index }) {
  ...
  return (
    <div
      ref={cardRef}
      className={`group relative border border-white/10 bg-[#0a0a0a] overflow-hidden cursor-pointer project-card ${project.minHeight}`}
      style={{
        gridColumn: `span ${project.colSpan.base}`,
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-between p-6 md:p-8">
        <div className="flex items-start justify-between gap-4">
          <div className="premium-serif premium-serif-medium text-sm md:text-base tracking-[0.15em] text-white/70 uppercase">
            {project.tag}
          </div>
        ...
        <div className="overflow-hidden">
          <div className="transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700 ease-out">
            <h3 className="premium-serif premium-serif-medium text-4xl md:text-6xl leading-[0.95] tracking-tight">
              {project.title}
            </h3>
            <p className="mt-4 premium-serif premium-serif-light text-base md:text-lg text-white/50 max-w-xl leading-relaxed tracking-wide">
              {project.description}
            </p>
          </div>
        </div>
    ...
    >
      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-10 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-20 gap-8">
          <div>
            <div className="text-xs uppercase tracking-[0.3em] text-white/40 mb-4 premium-serif premium-serif-medium">
              Selected Work — 005
            </div>
            <h2 className="premium-serif premium-serif-medium text-6xl md:text-8xl lg:text-9xl leading-[0.9] tracking-tight">
              Projects.
            </h2>
          </div>
        </div>
        ...
        <div
          className="grid grid-cols-12 gap-4 md:gap-6 auto-rows-min grid-flow-dense"
          style={{
